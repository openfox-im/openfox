...
import { handleIntentCommand } from "../commands/intent.js";
...
export const ROOT_COMMANDS: readonly RootCommandDefinition[] = [
  ...
  { name: "intent", invocation: "openfox intent ...", summary: "Execute and inspect 2046 intent pipeline operations", handler: handleIntentCommand },
